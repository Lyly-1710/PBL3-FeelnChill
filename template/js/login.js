...
create.addEventListener('click', regis);

let login = document.getElementsByClassName("content")[0];
let reg = document.getElementsByClassName('regis-form')[0];
let reg_btn = document.getElementsByClassName('register-button')[0];
function regis() {
